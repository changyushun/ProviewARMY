...
<script type="text/javascript" src="JS/htmileditor/jquery.cleditor.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        //    //if (confirm('注意~請再次確認新增資料是否正確~新增簽章後將無法刪除!!')) {
        //        var date = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_TextBox1').value;
        //        var unit = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_TextBox3').value;
        //        var rank = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_TextBox4').value;
        //        var name = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_TextBox5').value;
        //        var ch = dateValidationCheck(date.trim());
        //        //檢查欄位是否空白
        //        if (date == "" | unit == "" | rank == "" | name == "") {
        //            alert('輸入欄位不可空白');
        //            return false;//輸入return false就會中斷，不會送回sv
        //        }
        //        else {
        //            if (ch == 1) {
        //                return true;
        ...
        //document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1').tabIndex.valueOf(2);
    </script>
    <script type="text/javascript">
        //接收子視窗回傳值要執行的方法。
        function outside() {
...
&nbsp;&nbsp;<asp:Image ID="Image1b" runat="server" Height="90px" Width="270px" />
            ...
            <asp:Label ID="Label5b" runat="server" Font-Names="標楷體" Font-Size="Large" ForeColor="Blue" Font-Bold="True" >新增鑑測官簽章：</asp:Label>
                ...
                <br /><br />
                <asp:Label ID="Label18" runat="server" Font-Bold="True" Font-Names="標楷體" Font-Size="Large" ForeColor="Black">(2)簽章級職：</asp:Label>
...
&nbsp;<asp:Label ID="Label8a" runat="server" Font-Names="標楷體" Font-Size="Large"></asp:Label>
            ...
            <br /><br />
                ...
                <br /><br />
                <asp:Label ID="Label21" runat="server" Font-Bold="True" Font-Names="標楷體" Font-Size="Large" ForeColor="Black">(2)簽章級職：</asp:Label>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableModelValidation="True" AllowPaging="True" AllowSorting="True" Font-Size="Larger">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="start_date" HeaderText="啟用日期" SortExpression="start_date" />
                     <%--<asp:BoundField DataField="end_date" HeaderText="結束日期" SortExpression="end_date" />--%>
                    <asp:BoundField DataField="rank" HeaderText="簽章項目" SortExpression="rank" />
                    <asp:BoundField DataField="sing_unit" HeaderText="簽章單位" SortExpression="sing_unit" />
                    <asp:BoundField DataField="sing_rank" HeaderText="簽章級職" SortExpression="sing_rank" />
                    <asp:BoundField DataField="sing_name" HeaderText="簽章姓名" SortExpression="sing_name" />
