<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="HQ_TeamReserverCancel.aspx.cs" Inherits="HQ_TeamReserverCancel" %>
...
<script type="text/javascript">
    $(function() {
        ...
        if ($(this)[0].checked == true) {
            var el = document.getElementById("ctl00_ContentPlaceHolder1_TabContainer1_TabPanel_GridView1");
            el.style.backgroundColor = "#d1dbe0";
...
<ajaxToolkit:TabPanel runat="server" ID="TabPanel" HeaderText="團體報進人員取消作業">
    <HeaderTemplate>
        團體報進人員取消作業
    </HeaderTemplate>
<ContentTemplate>
...
<div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [sid], [name], [id], [age] FROM [Result] WHERE (([date] = @date) AND ([op_id] = @op_id) AND ([center_code] = @center_code) AND ([status] = @status))">
        <SelectParameters>
