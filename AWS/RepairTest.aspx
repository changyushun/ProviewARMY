<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RepairTest.aspx.cs" Inherits="RepairTest" %>
...
<ajaxToolkit:TabPanel runat="server" ID="TabPanel" HeaderText="申請補測報進作業">
...
<div id="beagain" style="display:none;" runat="server">
	<span style="color:red; width: 200px; font-size: 16px; font-weight: bold; text-align: left; font-family: 微軟正黑體; ">您為30天原地補測人員,距上次測驗30天內無法申請補測,請選擇基本項目報進或替代方案報進</span>
</div>
...
<div id="nevertest" style="display:none;" runat="server">
	<span style="color:red; width: 200px; font-size: 16px; font-weight: bold; text-align: left; font-family: 微軟正黑體; ">您今年度尚未測驗,無法申請補測報進</span>
</div>
<div id="errorcenter" style="display:none;" runat="server">
	<span style="color:red; width: 200px; font-size: 16px; font-weight: bold; text-align: left; font-family: 微軟正黑體; ">請選擇與上次測驗有相同替代項目的鑑測站</span>
</div>
...
<div id="zerorder" style="display:none;" runat="server">
    ...
    OnRowDataBound="GridView2_OnRowDataBound" OnDataBound="GridView2_OnDataBound">
        <Columns>
            ...
            <asp:HyperLinkField Text="變更" Target="_self" DataNavigateUrlFields="center_code,date" DataNavigateUrlFormatString="RepairTestChange.aspx?center_code={0}&date={1}" HeaderText="變更"/>
            <asp:HyperLinkField Text="刪除" Target="_self" DataNavigateUrlFields="center_code,date" DataNavigateUrlFormatString="RepairTestCancel.aspx?center_code={0}&date={1}" HeaderText="刪除"/>
        </Columns>
    </asp:GridView>
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ConnectionString="<%$ ConnectionStrings:MainDB %>"
        SelectCommand="SELECT DISTINCT CONVERT(varchar(10), date,111) AS date, (SELECT center_name FROM Center AS c WHERE (center_code = r.center_code)) AS center_name, op_id, center_code FROM Result AS r WHERE (id = @op_id and status = '000' and date > @date and result = 'FFF')">
            <SelectParameters>
