<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RepairTestCancel.aspx.cs" Inherits="RepairTestCancel" %>
...
<ajaxToolkit:TabPanel runat="server" ID="TabPanel" HeaderText="申請補測取消作業">
    <HeaderTemplate>
        申請補測取消作業
    </HeaderTemplate>
<ContentTemplate>
...
<div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [sid], [name], [id], [age] FROM [Result] WHERE (([date] = @date) AND ([id] = @op_id) AND ([center_code] = @center_code) AND ([status] = @status) AND ([result] = 'FFF'))">
        <SelectParameters>
