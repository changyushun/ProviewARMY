<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SelfReverserChange.aspx.cs" Inherits="SelfReverserChange" MaintainScrollPositionOnPostback="true" %>
...
<script type="text/javascript">
    $(function() {
        ...
        $('#Button4').click(function() {
            window.location.href = "SelfReserver.aspx";
        });
...
<ajaxToolkit:TabPanel runat="server" ID="TabPanel" HeaderText="基本三項變更作業">
...
<div id="thisyearnevertest" style="display:none;" runat="server">
	<span style="color:red; width: 200px; font-size: 16px; font-weight: bold; text-align: left; font-family: 微軟正黑體; ">無法變更至跨年度的日期</span>
</div>
