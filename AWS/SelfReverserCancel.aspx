<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SelfReverserCancel.aspx.cs" Inherits="SelfReverserCancel" %>
...
<ajaxToolkit:TabPanel runat="server" ID="TabPanel" HeaderText="基本三項取消作業">
    <HeaderTemplate>
        基本三項取消作業
    </HeaderTemplate>
<ContentTemplate>
